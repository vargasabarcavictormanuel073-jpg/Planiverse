  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="bg-slate-800/60 backdrop-blur-md rounded-3xl shadow-2xl p-8 sm:p-10 border border-white/10">
        ...
        {/* Botón de Google con gradiente azul → morado */}
        <button
          type="button"
          onClick={handleGoogleLoginClick}
          disabled={isLoading}
          className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full text-white font-bold text-lg hover:shadow-2xl hover:from-blue-500 hover:to-purple-500 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-purple-500/50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
          aria-label="Iniciar sesión con Google"
        >
          <svg className="w-6 h-6 bg-white rounded-full p-1 flex-shrink-0" viewBox="0 0 24 24" aria-hidden="true">
