...
interface ProfileData {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let existingProfile = await FirestoreService.read<ProfileData>('profile', 'data', userId);
      ...
      console.log('✅ Perfil guardado en Firestore:', updatedProfile);
      ...
      console.log('🚀 Llamando onComplete con rol:', selectedRole);
