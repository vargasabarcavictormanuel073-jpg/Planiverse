...
import GradeCalculator from '@/components/tools/HerramientaCalculadoraNotas';
import PomodoroTimer from '@/components/tools/HerramientaTemporizadorPomodoro';
import ScheduleGenerator from '@/components/tools/HerramientaGeneradorHorarios';
import SuppliesList from '@/components/tools/HerramientaListaUtiles';
import ExamCountdown from '@/components/tools/HerramientaCuentaRegresivaExamenes';
import AttendanceList from '@/components/tools/HerramientaControlAsistencia';
import RubricGenerator from '@/components/tools/HerramientaGeneradorRubricas';
import ActivityBank from '@/components/tools/HerramientaBancoActividades';
import EvaluationCalendar from '@/components/tools/HerramientaCalendarioEvaluaciones';
import GroupStats from '@/components/tools/HerramientaEstadisticasGrupo';
